...
# The value inside <> is what is being passed from the html template
@app.route("/edit_category/<int:category_id>", methods=["GET", "POST"])
def edit_category(category_id):
    #have to specify what category means as variable not passed to the 
    #html page like in def categories()
    #also value needs to be passed to function so that is available for use
